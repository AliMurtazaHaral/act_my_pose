...
class AudienceEditProfileScreen extends StatefulWidget {
  const AudienceEditProfileScreen({Key? key}) : super(key: key);

  @override
  State<AudienceEditProfileScreen> createState() => _AudienceEditProfileScreenState();
}

class _AudienceEditProfileScreenState extends State<AudienceEditProfileScreen> {
  ...
  postDetailsToFirestore() async {
    ...
    await firebaseFirestore
        .collection("users")
        .doc(user?.uid)
        .update(userModel.toUpdateAudience());
